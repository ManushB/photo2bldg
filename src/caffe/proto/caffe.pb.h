...
class TripletLossParameter : public ::google::protobuf::Message {
 public:
  ...
  inline TripletLossParameter* New() const { return New(NULL); }

  TripletLossParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class InsanityParameter : public ::google::protobuf::Message {
 public:
  ...
  inline InsanityParameter* New() const { return New(NULL); }

  InsanityParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class BNParameter : public ::google::protobuf::Message {
 public:
  ...
  bool has_var_eps() const;
  void clear_var_eps();
  static const int kVarEpsFieldNumber = 3;
  float var_eps() const;
  void set_var_eps(float value);

  // optional bool moving_average = 4 [default = true];
  bool has_moving_average() const;
  void clear_moving_average();
  static const int kMovingAverageFieldNumber = 4;
  bool moving_average() const;
  void set_moving_average(bool value);
